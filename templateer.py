...
format = 'what to do with the {elements} from each row of data'
...
def process(tabular, format, header='', footer='', meta={}):
	...
	#rows = [{names[index]: line[index] for index in range(len(line))} for line in lines]
	rows = []
	for line in lines:
		row = {}
...
format = '{first}{t}{last}{t}{phone}{t}{company}{t}{t}{t}{t}'
